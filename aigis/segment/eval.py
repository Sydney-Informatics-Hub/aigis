...
class SegmentationModelEvaluator:
    ...
    def evaluate(self, cfg):
        ...
        Args:
            cfg (detectron2.config.config.CfgNode): The configuration for the model.
    ...
    def calculate_mean_iou(self):
        """Calculate the mean Intersection over Union (IoU) for the
        segmentation model.
    ...
    def _compute_iou(self, pred_masks, gt_masks):
        """Compute the Intersection over Union (IoU) between predicted masks
